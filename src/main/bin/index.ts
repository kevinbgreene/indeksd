...
// import { parseFiles, ParseOptions, DatabaseDefinition } from '../index';
...
// parseFiles(options).forEach((ast: DatabaseDefinition, index: number): void => {
...
//     options.outDir,
//   );
//   const outFile: string = path.resolve(outDir, file.replace('.db', '.json'));
